    ...
    <>
      <nav style={{
        ...
        <div className="nav-desktop" style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
          <ul style={{ display: 'flex', gap: '2rem', listStyle: 'none', margin: 0 }}>
            {links.map(l => (
              <li key={l.href}>
                <a href={l.href} style={{
                  fontSize: '14px', color: 'rgba(226,232,240,0.75)',
                  textDecoration: 'none', fontWeight: 400, transition: 'color 0.2s',
                }}
                  onMouseEnter={e => (e.currentTarget.style.color = '#1ab8d4')}
          ...
          <button onClick={onRequestPilot} style={{
            ...
            fontFamily: 'inherit',
            boxShadow: '0 0 16px rgba(26,184,212,0.3)', transition: 'box-shadow 0.2s',
          }}
            onMouseEnter={e => (e.currentTarget.style.boxShadow = '0 0 24px rgba(26,184,212,0.5)')}
            onMouseLeave={e => (e.currentTarget.style.boxShadow = '0 0 16px rgba(26,184,212,0.3)')}>
            Request a pilot
          </button>
        </div>
        ...
        <button
          ...
          style={{
            background: 'none', border: '1px solid rgba(26,184,212,0.3)',
            borderRadius: '8px', color: '#1ab8d4', cursor: 'pointer',
        ...
        <div className="nav-mobile" style={{
          ...
          {links.map(l => (
            <a key={l.href} href={l.href}
              ...
              style={{
                fontSize: '16px', color: 'rgba(226,232,240,0.8)',
          ...
          <button
            ...
            style={{
              marginTop: '16px',
              background: 'linear-gradient(135deg, #0e6b7c, #1ab8d4)',
              color: 'white', padding: '13px 22px', borderRadius: '8px',
